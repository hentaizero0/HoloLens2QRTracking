            ...
            lock (pendingActions)
            {
                while (pendingActions.Count > 0)
                {
                    ...
                    if (action.type == ActionData.Type.Added)
                    {
                        ...
                        // GameObject handObject = Instantiate(hand, new Vector3(0, 0, 0), Quaternion.identity);
                        qrCodeObject.GetComponent<SpatialGraphNodeTracker>().Id = action.qrCode.SpatialGraphNodeId;
                        qrCodeObject.GetComponent<QRCode>().qrCode = action.qrCode;
                        qrCodesObjectsList.Add(action.qrCode.Id, qrCodeObject);
                        // handObject.GetComponent<SpatialGraphNodeTracker>().Id = action.qrCode.SpatialGraphNodeId;
                        // handObject.GetComponent<QRCode>().qrCode = action.qrCode;
                        // qrCodesObjectsList.Add(action.qrCode.Id, handObject);
                    }
